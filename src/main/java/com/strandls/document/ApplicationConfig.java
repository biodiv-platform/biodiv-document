 ...
 *
 */
@OpenAPIDefinition(info = @Info(title = "Document Module MicroServices", version = "1.0.0", description = "API for Document Module"), servers = {
		@Server(url = "http://localhost:8080/document-api/api") })
